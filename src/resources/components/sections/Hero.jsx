...
import portfolioAnim from 'src/resources/assets/SVG/ProgrammingComputer.lottie';
import mlLogo from 'src/resources/assets/PNG/melilogo.png';
      ...
      <div className="hero-container">
        ...
        <motion.div 
          ...
          renderConfig={{ autoResize: true, // Automatically adjusts canvas size when the container resizes
                          devicePixelRatio: window.devicePixelRatio}} // Optional: ensures sharpness on high-DPI screens
              />
        </motion.div>
      </div>
    </header>
