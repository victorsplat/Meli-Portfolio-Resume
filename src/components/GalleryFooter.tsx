...
const socialLinks: { icon: React.ComponentType<{ className?: string }>; label: string; href: string }[] = [
...
export default function GalleryFooter({ t, onClose: _onClose }: GalleryFooterProps) {
